...
/** L2 索引概览（Workspace 级，不绑定 Session）。 */
export interface MemoryL2OverviewEvent {
	readonly type: "memory:l2_overview";
	readonly overview: L2Overview;
}
